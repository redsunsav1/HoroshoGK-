...
export const PROJECTS: Project[] = [
  {
    ...
    timeline: [
      { id: 'tl1', date: '2021-03-15', title: 'Старт продаж', description: 'Открытие офиса продаж и начало бронирования квартир' },
      { id: 'tl2', date: '2021-06-01', title: 'Начало строительства', description: 'Закладка фундамента первого дома' },
      { id: 'tl3', date: '2022-04-20', title: 'Завершение монолита', description: 'Монолитные работы завершены на 100%' },
      { id: 'tl4', date: '2022-09-10', title: 'Фасадные работы', description: 'Начало облицовки фасадов баварским кирпичом' },
      { id: 'tl5', date: '2023-06-15', title: 'Благоустройство', description: 'Завершение внутренней отделки, начало благоустройства двора' },
      { id: 'tl6', date: '2023-12-20', title: 'Ввод в эксплуатацию', description: 'Получено разрешение на ввод, начало выдачи ключей' },
    ]
  },
  {
    id: '2',
